...
//slide 3 icon
var star_one = `<span class="span-star--project"> <div class="tooltip-container" style="display: flex !important;"> <img src="assets/images/icon/star.png" alt="icone" class="icon-project" alt="personne icon" width="15" height="15"> <img src="assets/images/icon/star_empty.png" class="icon-project" alt="personne icon" width="15" height="15"> <img src="assets/images/icon/star_empty.png" class="icon-project" alt="personne icon" width="15" height="15"> <img src="assets/images/icon/star_empty.png" class="icon-project" alt="personne icon" width="15" height="15"> <img src="assets/images/icon/star_empty.png" class="icon-project" alt="personne icon" width="15" height="15"> ${description_star} </div>`;
